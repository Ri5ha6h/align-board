		...
		<div className="flex items-center justify-center">
			<Sheet open={open} onOpenChange={handleSheetOpen}>
				<SheetTrigger asChild>
					<Button className="cursor-pointer" variant={props.variant}>
						{props.buttonTitle}
					</Button>
				</SheetTrigger>
				<SheetContent>
					...
					<ScrollArea className="h-[calc(100%-50px)] w-full py-5">
						<AddStatusForm
							state={props.state}
			...
			<Form {...form}>
				...
				>
					<FormField
						...
						render={() => (
							<FormItem>
								<FormLabel className="text-base" htmlFor={`${id}-env`}>
									Environment
								</FormLabel>
								<FormControl id={`${id}-env`}>
					...
					<FormField
						...
						render={() => (
							<FormItem>
								<FormLabel className="text-base" htmlFor={`${id}-mode`}>
									Mode
								</FormLabel>
								<FormControl id={`${id}-mode`}>
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem className="mt-4">
								<FormLabel className="text-base" htmlFor={`${id}-carrier`}>
									Carrier
								</FormLabel>
								<Select
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem className="mt-4">
								<FormLabel className="text-base" htmlFor={`${id}-status`}>
									Status
								</FormLabel>
								<Select onValueChange={field.onChange} value={field.value}>
									<FormControl id={`${id}-status`}>
										<SelectTrigger className="w-full">
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem className="mt-4">
								<FormLabel className="text-base" htmlFor={`${id}-statusType`}>
									Status Type
								</FormLabel>
								<Select onValueChange={field.onChange} value={field.value}>
									<FormControl id={`${id}-statusType`}>
										<SelectTrigger className="w-full">
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem className="mt-4">
								<FormLabel className="text-base" htmlFor={`${id}-issue`}>
									Issue
								</FormLabel>
								<FormControl id={`${id}-issue`}>
									<Textarea
										className="h-24"
										placeholder="issue..."
										required
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem className="mt-4">
								<FormLabel className="text-base" htmlFor={`${id}-impact`}>
									Impact
								</FormLabel>
								<FormControl id={`${id}-impact`}>
									<Textarea
										className="h-24"
										placeholder="impact..."
										required
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem className="mt-4">
								<FormLabel className="text-base" htmlFor={`${id}-jiraLink`}>
									Jira Link
								</FormLabel>
								<FormControl id={`${id}-jiraLink`}>
									<Input
										type="text"
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem className="mt-4 flex flex-col">
								<FormLabel
									className="text-base"
									htmlFor={`${id}-expectedResolutionDate`}
								>
									Expected Resolution Date
								</FormLabel>
								<Popover>
									<PopoverTrigger asChild>
										<FormControl id={`${id}-expectedResolutionDate`}>
											<Button
												variant={"outline"}
												className={cn(
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem className="mt-4">
								<FormLabel className="text-base" htmlFor={`${id}-resolution`}>
									Resolution
								</FormLabel>
								<Select onValueChange={field.onChange} value={field.value}>
									<FormControl id={`${id}-resolution`}>
										<SelectTrigger className="w-full">
