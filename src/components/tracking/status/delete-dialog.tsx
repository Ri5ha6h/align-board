...
import { CustomTrash } from "@/components/icons/icons";
				...
				<DialogContent className="sm:max-w-[425px]">
					<DialogHeader>
						...
						<DialogDescription>
							...
							<span className="font-bold text-black">{props.statusKey}</span> to
							delete the status.
						</DialogDescription>
					</DialogHeader>
						...
						<Form {...form}>
							...
							>
								<FormField
									...
									render={({ field }) => (
										<FormItem>
											<FormLabel htmlFor={`${id}-statusKey`}>
												Status Key
											</FormLabel>
											<FormControl id={`${id}-statusKey`}>
