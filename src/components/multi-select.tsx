...
// Custom multi-select component built using shadcn/ui primitives.
// This file composes Badge, Command, and other shadcn/ui components for advanced selection UI.
